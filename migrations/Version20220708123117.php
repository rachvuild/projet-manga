 ...
 */
final class Version20220708123117 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE opening_account (opening_id INT NOT NULL, account_id INT NOT NULL, INDEX IDX_495CF824464F291F (opening_id), INDEX IDX_495CF8249B6B5FBA (account_id), PRIMARY KEY(opening_id, account_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
